#ifndef __Sx1278_LoRaMisc_H
#define __Sx1278_LoRaMisc_H
...
void Sx1278_LoRa_Set_RxSingleOn( bool enable );
void Sx1278_LoRa_Set_TxPacketTimeout( uint32_t value );
void Sx1278_LoRa_Set_RxPacketTimeout( uint32_t value );
